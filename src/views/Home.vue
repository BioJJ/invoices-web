    ...
    <v-row class="mb-3">
        ...
        <v-card class="pt-10 pb-7 px-6 pgc-card-box">
          <v-row>
            <v-col cols="12">
              <cardInfo
                title="Twiiter '-'"
                message="⚓💫 Forever isn’t for
              everyone 🤗 ◣✠◥"
                color="#26c6da"
                title2="Jefferson Coelho"
                icon="mdi-twitter"
                url="https://avatars.githubusercontent.com/u/33555544?v=4"
                href="https://twitter.com/bio_jefferson"
              />
            </v-col>
          </v-row>
        </v-card>
          ...
          <v-row>
            <v-col cols="12">
              <cardInfo
                ...
                message="registration amount: 20"
                color="red"
                icon="mdi-garage"
                href="http://localhost:3030/establishments"
              />
            </v-col>
          </v-row>
        </v-card>
        ...
        <v-card class="pt-10 pb-7 px-6 pgc-card-box">
          <v-row>
            <v-col cols="12">
              <cardInfo
                title="Notes"
                message="registration amount: 25"
                color="green"
                icon="mdi-text-box-plus-outline"
                href="http://localhost:3030/notes"
              />
            </v-col>
          </v-row>
        </v-card>
      ...
      <v-col cols="6">
        <v-card class="pt-10 pb-7 px-6 pgc-card-box">
          <v-row>
            <v-col cols="12">
              <graphic title="Notes" message="25" color="yellow" href="notes" />
            </v-col>
          </v-row>
        </v-card>
      </v-col>
        ...
        <v-card class="pt-10 pb-7 px-6 pgc-card-box">
          <v-row>
            <v-col cols="12">
              <cardRatings
                title="GitHub"
                message="Perfil BioJJ"
                color="yellow"
                href="https://github.com/BioJJ"
          ...
          <v-row>
            <v-col cols="12">
              <cardRatings
                ...
                message="Repositorio"
                color="yellow"
                href="https://github.com/BioJJ/invoices-web"
                url="data:image/png;base64,"
              />
            </v-col>
          </v-row>
...
import CardRatings from "@/components/dashboard/CardRatings.vue";
